        ...
        <div className="free-tips text-white rounded-md">
            ...
            <ul className="tips-container ">
                <li className="tip w-full mx-auto bg-[#000435] pt-2">
                    ...
                    <aside className="odds-container flex flex-row gap-10 justify-center items-center">
                        <div className="border w-[100px] my-2 rounded-md text-amber-400 font-semibold">ODDS</div>
                        <div className="home border w-[100px] my-2 rounded-md"><span className="text-gray-500 mr-5 text-sm">1</span>1.25</div>
                        <div className="draw border w-[100px] my-2 rounded-md"><span className="text-gray-500 mr-5 text-sm">x</span>2.25</div>
                        <div className="away border w-[100px] my-2 rounded-md"><span className="text-gray-500 mr-5 text-sm">2</span>1.98</div>
                    </aside>
